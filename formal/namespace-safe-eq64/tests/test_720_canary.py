...
class Canary720Tests(unittest.TestCase):
    ...
    def test_real_receipt_roundtrip_and_fresh_dependency_rehash(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            verified = verify_receipt_dependencies(
                ROOT,
                source_path,
                target_path,
                evidence_path,
    ...
    def test_fresh_dependency_rehash_rejects_post_receipt_evidence_mutation(self):
        source_path = ROOT / "fixtures" / "x_aiprbg_6gate.json"
        target_path = ROOT / "fixtures" / "ess_eq64_6d_kernel.json"
        source = load_namespace(source_path)
        target = load_namespace(target_path)
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaisesRegex(
                ValueError,
                "DEPENDENCY_SHA256_MISMATCH:evidence_sha256",
            ):
                verify_receipt_dependencies(
                    ROOT,
                    source_path,
